...
- **Anchor:** A locally named region that belongs to exactly one object or surface, identified by a descriptive `name` and a functional `role`, and can be referenced as a relation target.
